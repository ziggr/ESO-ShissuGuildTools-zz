...
Shissu_SuiteManager_SettingMenu = {}
...
function ShissuCreateControl.panel(parent, panelData, controlName)
  ...
  control.feedback:SetHandler("OnClicked", function()
      Shissu_Feedback_Feedback:SetHandler("OnClicked", function() Shissu_SuiteManager._lib.feedback(0, panelData.displayName) end)
      Shissu_Feedback_500:SetHandler("OnClicked", function() Shissu_SuiteManager._lib.feedback(500, panelData.displayName) end)
...
function ShissuCreateControl.colorpicker(parent, colorData)
  ...
  control.label:SetText(Shissu_SuiteManager._lib.ReplaceCharacter(colorData.name))
...
function ShissuCreateControl.textbox(parent, textBoxData)
  ...
  control.label = CreateControl(nil, control, CT_LABEL)
  control.label:SetFont("ZoFontGame")
  control.label:SetText(Shissu_SuiteManager._lib.ReplaceCharacter(textBoxData.name))
	control.label:SetWidth(width-100)
  control.label:SetAnchor(TOPLEFT)
...
function _settings.CreateAddonSettingsMenuEntry()
	local panelData = {
		...
		name = "|cAFD3FFShissu's|r|ceeeeee AddOns",
	}
